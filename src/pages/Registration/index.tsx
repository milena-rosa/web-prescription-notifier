...
export function Registration() {
  ...
  const handleSave = async () => {
    const formattedData = {
      ...
      registration_date: toDate(data.registration_date),
      record_number_a: data.record_number_a,
      record_number_b: data.record_number_b,
      prescription_types: data.prescription_types,
      professional_or_institution_name: data.professional_or_institution_name,
      technical_or_clinical_director: data.technical_or_clinical_director,
      professional_council_register: data.professional_council_register,
      council_type: data.council_type,
      specialty: data.specialty,
      telephone_number: data.telephone_number.replace(/[^0-9]/g, ''),
      cellphone_number: data.cellphone_number.replace(/[^0-9]/g, ''),
      email: data.email,
  ...
  const { data, handleChange, errors, setValue, handleSubmit } = useForm<RegistrationFormValues>({
    ...
    onSubmit: handleSave,
    validations: {
      registration_number: { required: { message: 'Campo obrigatório', value: true } },
      registration_date: { required: { message: 'Campo obrigatório', value: true } },
      record_number_a: { required: { message: 'Campo obrigatório', value: true } },
      record_number_b: { required: { message: 'Campo obrigatório', value: true } },
      prescription_types: { required: { message: 'Campo obrigatório', value: true } },
      professional_or_institution_name: { required: { message: 'Campo obrigatório', value: true } },
      professional_council_register: { required: { message: 'Campo obrigatório', value: true } },
      specialty: { required: { message: 'Campo obrigatório', value: true } },
      cellphone_number: { required: { message: 'Campo obrigatório', value: true } },
      email: { required: { message: 'Campo obrigatório', value: true } },
      business_address: { required: { message: 'Campo obrigatório', value: true } },
      home_address: { required: { message: 'Campo obrigatório', value: true } }
    }
  })
  ...
  return (
    <>
      <ConfirmationModal
        ...
        messageDescription="As informações foram salvas com sucesso"
      />
