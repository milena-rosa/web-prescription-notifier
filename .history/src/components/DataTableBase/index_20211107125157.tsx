...
// import { ChevronDown, ChevronLeft, ChevronRight, ChevronsLeftReward, ChevronsRightForward } from '@somostera/tera-icons'

import { ChevronDown, ChevronLeft, ChevronRight, ChevronsLeftReward } from '../Icon'
